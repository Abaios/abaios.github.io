...
<div x-data="channelSelector('stream', true)" class="bg-white overflow-hidden shadow rounded-lg">
	<div x-data="widgetsGenerator('stream')">
		<div class="bg-gray-50 border-b border-gray-200 px-4 py-5 sm:px-6">
			<div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
				...
				<div class=" flex justify-between items-center flex-wrap sm:flex-nowrap">
					...
					<div class="ml-4 mt-4 items-center">
						<button type="button"
								class="stream-color-picker relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring ring-blue-100 focus:border-blue-300 transition ease-in-out duration-150 sm:text-sm">
							<div class="flex items-center">
								<span class="stream-color-picker-indicator flex-shrink-0 inline-block h-4 w-4 rounded"
				...
				<div class="w-full ml-5">
					<div class="mt-1 flex rounded-md shadow-sm ">
						<div class="relative flex items-stretch flex-grow focus-within:z-10">
							<input id="stream-shortcode" x-bind:value="getShortcode()" type="text"
						...
						<button data-clipboard-target="#stream-shortcode"
		...
		<div id="stream-embedded-player" class="px-4 py-5 sm:p-6">
		</div>
	</div>
</div>
