...
#region GENERAL OPTIONS
	...
	public function generalOptionsCallback() {
		echo '<p style="margin-top: 10px;">' . esc_html__( 'This plugin requires you to have an account at Caster.fm API and set your API Private Token.', 'wpradio' ) . "<br /><a style='margin-top:10px' class='button button-secondary' href='" . Helpers::getRegistrationLink( $this->affiliateId ) . "'>" . __( 'Caster.fm API Registration', 'wpradio' ) . "</a>" . '</p>';
	}
