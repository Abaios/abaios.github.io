 ...
 *
 *
 * @link              https://api.caster.fm/wordpress-radio
 * @since             1.0.0
 * @package           WPRadio
 *
 * @wordpress-plugin
 * Plugin Name:       WPRadio
 * Plugin URI:        https://api.caster.fm/wordpress-radio
 * Description:       Wordpress Radio is an entire radio streaming platform embedded in your WordPress site
 * Version:           1.0.3
 * Author:            Caster.fm
 * Author URI:        https://api.caster.fm/
 * License:           GPL-2.0
 ...
 */
define( 'WPRADIO_DEBUG', true );

/**
 * Some Caster.fm API URLS
 */
define( 'WPRADIO_CASTERFMAPI_HUB', 'https://hub.api.caster.fm/' );
define( 'WPRADIO_CASTERFMAPI_CONSOLE', 'https://console.api.caster.fm/' );
define( 'WPRADIO_CASTERFMAPI_CDN', 'https://cdn.api.caster.fm/' );

define( 'WPRADIO_CASTERFMAPI_TUTORIALS', 'https://api.caster.fm/docs/tutorials' );
