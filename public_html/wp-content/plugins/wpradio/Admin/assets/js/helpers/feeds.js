...
const newsFeed = () => {
  return axios.get('https://api.caster.fm/category/news/feed/json?tag=wpradio');
};

const announcementFeed = () => {
  return axios.get('https://api.caster.fm/category/announcements/feed/json?tag=wpradio');
};
