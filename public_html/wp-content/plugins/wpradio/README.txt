...
It utilizes [Caster.fm API](https://api.caster.fm/) to allow you to create an internet radio station and provide a management interface for the streaming server, listeners, widgets and podcasts management.
...
[Learn More About Caster.fm API Affiliates Program](https://api.caster.fm/affiliates)
...
3. [Register](https://console.api.caster.fm/register) for FREE at [Caster.fm API](https://api.caster.fm/) to get an api token
