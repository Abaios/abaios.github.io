...
<body>
<div data-type="streamPlayer" data-publicToken="{$this->settings->getPublicToken()}" data-theme="light" data-color="" data-channelId="{$channel}" data-rendered="false" class="cstrEmbed">
