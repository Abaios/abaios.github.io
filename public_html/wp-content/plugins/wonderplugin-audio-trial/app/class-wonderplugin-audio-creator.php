...
class WonderPlugin_Audio_Creator {
	...
	function render( $id, $configdata ) {
		...
		<?php
			$initd_option = 'wonderplugin_audio_initd';
		...
		<ul class="wonderplugin-tabs" id="wonderplugin-audio-tabs">
			<li class="wonderplugin-tab wonderplugin-tab-selected">	
				...
				<div class="wonderplugin-toolbar">	
					<input type="button" class="button" id="wonderplugin-add-mp3" value="<?php _e( 'Add MP3 or Live Audio', 'wonderplugin_audio' ); ?>" />
					<input type="button" class="button" id="wonderplugin-add-mp4" value="<?php _e( 'Add MP4 Video', 'wonderplugin_audio' ); ?>" style="margin-left:12px;" />
					<div class="wonderplugin-toolbar-options">
						...
						<label style="margin-right:4px;"><input type="button" class="button" id="wonderplugin-globalsettings" value="<?php _e( 'General Settings', 'wonderplugin_audio' ); ?>" /></label>
						<label style="margin-right:4px;"><input type="button" class="button" id="wonderplugin-sortlist" value="<?php _e( 'Sort List', 'wonderplugin_audio' ); ?>" /></label>
						<label style="margin-right:4px;"><input type="button" class="button" id="wonderplugin-reverselist" value="<?php _e( 'Reverse List', 'wonderplugin_audio' ); ?>" /></label>
						<label><input type="button" class="button" id="wonderplugin-deleteall" value="<?php _e( 'Delete All', 'wonderplugin_audio' ); ?>" /></label>
					</div>
				...
				<form>
					<fieldset>
						...
						$skins = array(
								...
								"barwithplaylistwithdownload" => "Bar with Playlist, Download and Share",
								"barwhite" => "White Bar",
								"barwhitewithplaylist" => "White Bar with Playlist",
								"barwhitewithplaylistwithdownload" => "White Bar with Playlist, Download and Share",
								"darkbox" => "Dark Box",
								"darkboxwithdownload" => "Dark Box with Download and Share", 
								"jukebox" => "Jukebox",
								"jukeboxwithdownload" => "Jukebox with Download and Share", 
								"whitebox" => "White Box",
								"whiteboxwithdownload" => "White Box with Download and Share",
								"whiteboxlive" => "White Box Live",
								"greybox" => "Grey Box",
								"greyboxwithdownload" => "Grey Box with Download and Share",
					...
					<div class="wonderplugin-audio-options-tabs" id="wonderplugin-audio-options-tabs">
						...
						<div class="wonderplugin-audio-options-tab wonderplugin-audio-options-tab-selected">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<p><label><input name='wonderplugin-audio-stopotherplayers' type='checkbox' id='wonderplugin-audio-stopotherplayers'  /> Pause all other players on the same webpage when starting playing</label></p>
								...
								<tr>
									...
									<td><label><input name='wonderplugin-audio-showliveplayedlist' type='checkbox' id='wonderplugin-audio-showliveplayedlist'  /> Show live streaming played tracks (for Shoutcast and Icecast)</label>
						...
						<div class="wonderplugin-audio-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<td><label><input name='wonderplugin-audio-wptracklist' type='checkbox' id='wonderplugin-audio-wptracklist'  />Do not show audio and image URLs in the HTML source code</label>
									<p style="font-style:italic;">* Please note, not showing the URLs in the HTML source code will NOT stop experienced visitors from downloading the files. This is NOT a DRM (Digital Rights Management) scheme to protect the audio file.</p>
									</td>
								</tr>
								<tr>
						...
						<div class="wonderplugin-audio-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<td>
									<label><input name='wonderplugin-audio-showinfo' type='checkbox' id='wonderplugin-audio-showinfo'  /> Show information: </label>
									<textarea name='wonderplugin-audio-infoformat' id='wonderplugin-audio-infoformat' type="text" class='large-text' rows="5"></textarea>
									</td>
								</tr>
						...
						<div class="wonderplugin-audio-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									<th>Download and Social Media Button CSS</th>
									<td><textarea name='wonderplugin-audio-socialcss' id='wonderplugin-audio-socialcss' value='' class='large-text' rows="15"></textarea></td>
								</tr>
							</table>
						</div>
						...
						<div class="wonderplugin-audio-options-tab">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<p><label><input name='wonderplugin-audio-addinitscript' type='checkbox' id='wonderplugin-audio-addinitscript'  /> Add init scripts together with the audio player HTML code. Check this option if your WordPress site uses Ajax to load pages and posts.</label></p>
									<p><label><input name='wonderplugin-audio-removeinlinecss' type='checkbox' id='wonderplugin-audio-removeinlinecss'  /> Do not add CSS to HTML source code</label></p>
									</td>
								</tr>
								<tr>
									<th>Custom CSS</th>
